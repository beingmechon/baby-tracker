 ...
 * Files: wfa_boys_0-to-5-years_zscores.xlsx, wfa_girls_0-to-5-years_zscores.xlsx, lhfa_boys_0-to-2-years_zscores.xlsx, lhfa_girls_0-to-2-years_zscores.xlsx
 *
...
export const WHO_WEIGHT_FOR_AGE: Record<'male' | 'female', readonly LmsPoint[]> = {
  male: [

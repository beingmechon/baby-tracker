...
export function findLastFeed(events: BabyEvent[]): FeedEvent | null {
...
export function findLastNursingSide(events: BabyEvent[]): BreastSide | null {
 ...
 */
export function sinceLastFeedMs(events: BabyEvent[], now: Timestamp): number | null {

...
export const en = {
  ...
  'activity.kind': 'What did you do?',
  'activity.minutes': 'How long? (minutes)',
  'activity.minutesNote': 'Leave it blank if nobody was counting.',
  'activity.save': 'Save activity',
  'activity.empty': 'Nothing logged yet.',
  'activity.emptyHint':
    'Tummy time is the one worth counting — the rest are here because they are nice to look back on.',
  'activity.today': 'Today',
  'activity.tummyToday': 'Tummy time today',
  'activity.tummyGoal': 'Daily tummy-time goal (minutes)',
  'activity.tummyGoalNote':
    'Your own target, not the app’s advice. Health services suggest working up to about an hour a day in short bursts by three months — ask yours what suits your baby.',
  'activity.tummyGoalMet': 'Goal reached',
  'activity.tummyGoalLeft': '{duration} to go',
  'activity.tummyNoGoal': 'No goal set',
  'activity.count.one': '{count} time',
  'activity.count.other': '{count} times',
  'activity.week': 'The last seven days',

  'potty.title': 'Potty',
  'potty.log': 'Log a potty trip',
  'potty.result': 'What happened?',
  'potty.result.pee': 'Wee',
  'potty.result.poo': 'Poo',
  'potty.result.both': 'Both',
  'potty.result.nothing': 'Nothing this time',
  'potty.result.accident': 'Accident',
  'potty.place': 'Where?',
  'potty.place.potty': 'Potty',
  'potty.place.toilet': 'Toilet',
  'potty.save': 'Save',
  'potty.empty': 'No potty trips logged.',
  'potty.emptyHint':
    'Sitting and nothing happening counts too — a week of it shows a pattern nobody could hold in their head.',
  'potty.today': 'Today',
  'potty.hits.one': '{count} success',
  'potty.hits.other': '{count} successes',
  'potty.misses.one': '{count} accident',
  'potty.misses.other': '{count} accidents',
  'potty.sits.one': '{count} sit with nothing',
  'potty.sits.other': '{count} sits with nothing',
  'potty.streak': 'Best clean run',
  'potty.streakDays.one': '{count} day',
  'potty.streakDays.other': '{count} days',
  'potty.streakNow': 'Currently {duration}',
  'potty.noStreak': 'No full day yet',
  'potty.note':
    'A record, not a scoreboard. Accidents are part of it and the numbers here are not a verdict on anybody.',
  'section.activity': 'Activities and potty',
  'event.activity': 'Activity',
  'event.potty': 'Potty',
  'toast.activitySaved': 'Activity saved',
  'toast.pottySaved': 'Saved',

  // Solids and allergens
  'food.title': 'Solids',
  'food.log': 'Log a food',
  'food.empty': 'No solids logged yet.',
  'food.emptyHint':
    'Whatever you offered and how it went. A week of it answers "has she had egg yet?" without anybody having to remember.',
  'food.name': 'What did you offer?',
  'food.namePlaceholder': 'e.g. scrambled egg, banana, dal',
  'food.recent': 'Offered before',
  'food.acceptance': 'How did it go?',
  'food.acceptance.refused': 'Refused it',
  'food.acceptance.tasted': 'Tasted it',
  'food.acceptance.some': 'Ate some',
  'food.acceptance.most': 'Ate most',
  'food.acceptance.all': 'Ate all of it',
  'food.allergens': 'Does it contain any of these?',
  'food.allergensNote':
    'You tell the app; it never guesses from the name. No food database here could know what is in the biscuit in your cupboard, and a wrong guess about egg is not a mistake worth risking.',
  'food.reaction': 'Did you notice a reaction?',
  'food.reactionShort': 'reaction noted',
  'food.reactionNote':
    'What it looked like goes in the note. This records; it does not assess. Breathing trouble, swelling of the face or mouth, or repeated vomiting after a food is emergency care — call your emergency number, not an app.',
  'food.save': 'Save food',
  'food.note': 'Anything else',
  'food.notePlaceholder': 'How it went, what it was mixed with',
  'food.tried.one': '{count} time',
  'food.tried.other': '{count} times',
  'food.lastOffered': 'last offered {ago}',
  'food.foodsTried': 'Foods offered',
  'food.allergenTitle': 'The nine major allergens',
  'food.allergenNote':
    'The nine named in United States federal law — the eight of the 2004 labelling act plus sesame, added in 2023. A published list, not a plan: what to introduce and when is a conversation with your doctor. Other countries name more.',
  'food.allergenProgress': '{offered} of {total} offered so far',
  'food.thisWeek': 'This week',
  'food.allergenNotTried': 'Not offered yet',
  'food.allergenNoReaction': 'No reaction noted',
  'food.allergenReacted': 'Reaction noted',
  'food.allergenReactedNote':
    'Worth mentioning to your doctor. The app is repeating what you logged, not making an assessment.',
  'allergen.milk': 'Milk',
  'allergen.egg': 'Egg',
  ...
  'reminders.intervalCustom': 'Another interval…',
  'reminders.intervalMinutes': 'Minutes between reminders',
  'reminders.firstDue': 'The first reminder',
  'reminders.firstDue.keep': 'Leave it as it is',
  'reminders.firstDue.lastFeed': 'An interval after the last feed',
  'reminders.firstDue.lastChange': 'An interval after the last change',
  'reminders.firstDue.lastPumping': 'An interval after the last session',
  'reminders.firstDue.now': 'An interval from now',
  'reminders.firstDue.at': 'At a time I choose',
  'reminders.firstDueTime': 'Due at',
  'reminders.firstDueDrift':
    'If something is logged after that, the reminder follows the log instead.',
  ...
  'error.enterInterval': 'Enter how many minutes, at least one.',
  'error.invalidTime': 'That time is not valid.',
  ...
  'error.enterFood': 'Say what you offered.',
